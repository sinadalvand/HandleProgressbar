package ir.lib.sinadalvand.Interpolator;
 ...
 */
public class AwesomeInterpolator implements Interpolator {

    private final Ease ease;

    public AwesomeInterpolator(@NonNull Ease ease) {
        this.ease = ease;
    }
